...
clean-Core-2f-Src-2f-Graphics:
	-$(RM) ./Core/Src/Graphics/color.cyclo ./Core/Src/Graphics/color.d ./Core/Src/Graphics/color.o ./Core/Src/Graphics/color.su ./Core/Src/Graphics/display.cyclo ./Core/Src/Graphics/display.d ./Core/Src/Graphics/display.o ./Core/Src/Graphics/display.su ./Core/Src/Graphics/matrix.cyclo ./Core/Src/Graphics/matrix.d ./Core/Src/Graphics/matrix.o ./Core/Src/Graphics/matrix.su ./Core/Src/Graphics/random.cyclo ./Core/Src/Graphics/random.d ./Core/Src/Graphics/random.o ./Core/Src/Graphics/random.su ./Core/Src/Graphics/time_display.cyclo ./Core/Src/Graphics/time_display.d ./Core/Src/Graphics/time_display.o ./Core/Src/Graphics/time_display.su
